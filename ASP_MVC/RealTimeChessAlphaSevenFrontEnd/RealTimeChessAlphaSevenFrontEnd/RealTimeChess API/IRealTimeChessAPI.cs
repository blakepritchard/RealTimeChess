...
namespace RealTimeChessAlphaSevenFrontEnd
{
    ...
    public partial interface IRealTimeChessAPI : IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiChessMatchesByIdSetupPostWithHttpMessagesAsync(int id, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<IList<MatchPlayer>>> ApiMatchPlayersGetWithHttpMessagesAsync(int? playerId = default(int?), int? chessMatchId = default(int?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiMovesBeginMovePostWithHttpMessagesAsync(int pieceId, int destinationX, int destinationY, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
